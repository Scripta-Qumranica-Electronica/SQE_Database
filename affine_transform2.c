...
my_bool affine_transform2_init( UDF_INIT *initid, UDF_ARGS* args, char* message );
char * affine_transform2(UDF_INIT *initid, UDF_ARGS *args, char *result, unsigned long *length, char *is_null, char *error);
void affine_transform2_deinit( UDF_INIT *initid );
